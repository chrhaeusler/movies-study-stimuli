...
# old scream: -attach-track affine transition.geometry=-8,-120:1300x975 \
#-video-track \
#meta.media.width=1280 meta.media.height=720 indicator/.all.png ttl=1 aspect_ratio=1 progressive=1 out=3297 \
#\
#-transition composite \
#\
melt -profile hdv_720_25p \
\
-video-track \
short_term_12_4029759096474.mkv force_fps=25.000 in=36097 out=39394 \
