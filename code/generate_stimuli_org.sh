##FORREST GUMP FOR MOVIE STUDY
##frames: 14500.0
##TRs of 2 sec: 290.0
##Duration: 580.000 sec
#\
#-video-track \
...
\
-video-track \
forrest_gump_bluray_orig.mkv force_fps=25.000 in=3185 out=17685 \
...
\
silence_1s.flac \
forrest_gump_ger_stereo.flac in=3185 out=17685 \
-mix 25 -mixer mix:-1 \
silence_5s.flac -mix 100 -mixer mix:-1 \
\
-consumer \
avformat:fg_av_ger_02:yy.xx_incl_11:yy.xx.avi \
